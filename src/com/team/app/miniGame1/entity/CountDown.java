...
//			countSleep = ActionCanvas.fps;
	...
	public void paint(Graphics g) {
		int canvasW = MiniGame1Canvas.instance.getWidth()/3;
		int canvasH = MiniGame1Canvas.instance.getHeight();
		if (index >= 0) {
			...
			int sy2 = (int) numIngH;
			g.drawImage(numImg, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, MiniGame1Canvas.instance);
		} else if(index == -1) {
			size = 1;
			...
			g.drawImage(startImg, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, MiniGame1Canvas.instance);
		} else if (index <= -2) {
