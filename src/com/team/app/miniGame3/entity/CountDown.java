...
//			countSleep = ActionCanvas.fps;
	...
	public void paint(Graphics g) {
		...
		if (index >= 0) {
			...
			int sy2 = (int) numIngH;
			g.drawImage(numImg, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, MiniGame3Canvas.instance);
		} else if (index == -1) {
			size = 2;
			...
			g.drawImage(startImg, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, MiniGame3Canvas.instance);
		} else if (index <= -2) {
